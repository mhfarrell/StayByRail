...
export const journalArticles = [
  {
    ...
    excerpt:
      "Sixteen days in Japan in the back half of January 2025. No JR Pass, a Suica card, the Yamanote Line, teamLab eggs, the Odaiba Gundam, a day of sumo, Osaka Castle after dark, Himeji, and a morning staring at Mount Fuji.",
    ...
    sections: [
      {
        ...
        body: "Right, I'll keep this short because I want to talk about the good stuff next. I went to Japan for sixteen days in the back half of January 2025. Not a lot of pre-planning, a rough list of places I'd always wanted to see, and I deliberately did not buy a JR Pass before flying. I'd read enough mixed things about whether the pass was still worth it after the big 2023 price hike, so I figured I'd just pay for tickets as I went and work it out on the fly. That turned out to be the right call for my specific trip, which was Tokyo-heavy with a couple of Shinkansen day trips. If you're doing a bigger loop around the country, the pass maths can still land on your side, check it against your actual route.\n\nThe other thing I figured out in the first 48 hours: the Yamanote Line is basically the one thing about Tokyo transport you have to learn. It's the big green loop that connects almost every district a visitor cares about. Shinjuku, Shibuya, Harajuku, Ueno, Tokyo Station, Ikebukuro, they're all on the same train, which turns up every two or three minutes, and it runs from about five in the morning to one at night. Once that clicked, the rest of the Tokyo subway map became much less intimidating. I grabbed a Suica card at the airport, loaded it with a few thousand yen, and pretty much stopped thinking about transport after that. Tap in, tap out, top up at a machine when it beeped at me.\n\nIf you've been on the fence about a January Japan trip: go. The weather was freezing most days but the sky was clear, the crowds were thin in all the best places, and every second thing I walked past turned out better than the tourist board photos.\n\nThis is not really a guide. It's more a collection of notes and pictures from the places that stuck with me. Tokyo, Osaka, Himeji, and a morning staring at Mount Fuji from a high viewpoint. Everything else got cut for space.",
      },
      {
        heading: "Tokyo is its own planet",
        body: "Tokyo is a place you can't really prepare for. The scale of it is something you only start to understand after about three days in. You'll be walking down a side street in some district you picked on a map because you'd heard the coffee was good, and you'll realise the side street is itself the size of a small European town. There are seven floors of restaurants stacked on top of each other in every block. There are ramen shops where you order at a vending machine on the wall. The whole city just hums.\n\nThe food is the first thing everyone tells you about and they're right, but not in the way I expected. I assumed 'food in Tokyo' meant booking into the fancy places and waiting for a Michelin star to land in my lap. What I actually did was eat in convenience stores, in standing-bar noodle shops, in the corner of a tiny izakaya where the chef grilled skewers on a binchotan grill about a metre from my face. Here's the short list of things you have to try, and I mean it: ramen (walk into the first place that has a queue, don't overthink it, every ramen shop in this country is better than anywhere I've been back home); a proper izakaya at least once, the kind of place where you order small plates one at a time and the night drifts by on beer and grilled fish; and sake, served slightly warm from a small ceramic cup in a back street in January. If you've only ever had sake as a cold shot at the end of a meal, you haven't actually had sake. And then the weirdly specific thing I got completely obsessed with, out of nowhere: melon soda. It's in every vending machine, every convenience store fridge, every family restaurant. It's bright green, it's sweeter than it has any right to be, and it is absolutely to die for. I was on about three a day by the second week.\n\nThe people surprised me most. I'd been warned that Tokyo is a place where strangers keep to themselves and you shouldn't expect conversation. That's technically true but it misses the bigger thing: when you do need help, the person you ask will drop whatever they're doing and walk you to where you need to go. I got lost looking for a shrine near Asakusa and a guy from a coffee shop came out onto the street with me to point at a specific corner three blocks away. He didn't know me, didn't want anything, just wanted to make sure I got there.\n\nAnd the onsens. We went to a place called Spa LaQua at Tokyo Dome City, which is a proper natural hot spring drilled 1,700 metres below Tokyo and piped up into a multi-floor spa complex with about six different baths across two floors, indoor and outdoor, plus a rooftop deck with more. It is not one of those rural wooden-building-in-the-mountains onsens you see on postcards, but the water is real and the routine is real and the effect is exactly the same. I'd only ever heard of onsens in the abstract as 'hot spring bath' which is technically correct but misses the point. The point is that you spend about forty minutes doing almost nothing and you come out feeling like you've had a week's sleep. They are the best thing Japan has invented, and that includes the train network, which is saying something.\n\nOne practical thing I'll mention since it kind of shaped the whole trip: I stayed at the APA Hotel Otsuka Eki Tower, and Otsuka turned out to be a genuine hidden gem of a hotel base. It's two Yamanote Line stops north of Ikebukuro, on the quieter end of the loop, and it has this weird luxury of being connected to both the Yamanote Line AND the Toden Arakawa Line, which is Tokyo's last remaining tram. Imagine a single-carriage streetcar that rattles through residential back streets all the way to Waseda and Minowabashi. Getting on it just to ride it is worth an afternoon on its own. The area around Otsuka Station is all small local restaurants: ramen, yakiniku, soba, a couple of standing bars with about eight seats each, mostly run by the people who live above the shop. Quiet after about 10pm, ten stops from anywhere on the green loop, and a proper fraction of the price of anything near Shinjuku or Shibuya.\n\nAnd the bonus feature that genuinely made the trip: this APA hotel has a proper onsen on the top floor of the tower. It turns out to be a thing APA do with a lot of their newer properties and I had no idea going in until I saw the lift button. You ride the lift up in your yukata with a little towel, and there's a real hot spring bath up there with a view out over the Tokyo rooftops. I used it most nights. Between that and the Spa LaQua trip earlier in the week, I was basically topped up on hot spring water for the whole sixteen days. If you're going to Tokyo and you haven't booked a hotel yet, just search Otsuka and take whatever's cheap, and if it happens to be an APA, so much the better.",
        image: {
      ...
      },
      {
        ...
        body: "teamLab was one of the things I went to Tokyo specifically for. I'd seen photos of the installations for years and kept telling myself I'd get there one day. I ended up at teamLab Planets on the first morning of the trip, still jet lagged and running on airport coffee, which turns out to be the ideal mental state for it. You take your shoes off at the door, roll your trouser legs up past your knees, and then wade through a room of waist-deep water with a thousand projected koi swimming around your shins.\n\nMy actual favourite room, by a long way, was the one where you lie flat on your back on a mirrored floor and the entire ceiling becomes a falling universe. Projections of light and shape cascade down from above and the mirrors throw it back in every direction. You lose a sense of up and down after about a minute and you just sort of stop thinking. I was in there for as long as they'd let me. That is the room I'd go back for, and if I ever end up at teamLab Borderless in the new Azabudai Hills building I'll be trying to find the equivalent immediately.\n\nThe reflective egg field is the more famous thing and it's in the outdoor section of the Planets site, where you walk between giant reflective ovoids on soft moss. The photo at the top of this post is from that room, taken with my phone on a slow shutter. It looks nothing like it does in person, in person the eggs pulse with colour depending on who's standing near which one and which ones have been nudged (they move when you touch them, very slightly). It ended up being the hero shot on this article mostly because it's one of the few photos from the day that doesn't have me in it. The rest of teamLab is genuinely hard to photograph without becoming part of the installation yourself.\n\nThen Odaiba itself. I am a big Gundam fan, so crossing over to see the Unicorn Gundam RX-0 statue at DiverCity was always going to be on the list, but I was not quite ready for how big it was in person. It is a full-scale Unicorn Gundam. It is 19.7 metres tall. It is parked on the plaza in front of the DiverCity mall like it just landed there on its way to something. At specific times each day the whole statue runs a transformation sequence where the armour panels shift and open up from 'unicorn mode' to 'destroy mode', with music and stage lighting, and I sat on a bench and watched it happen twice in a row. The second time through I was still grinning. If you're even slightly into the series you'll know exactly what I mean, and if you're not, it's still one of the most 'only in Japan' things you can do for free in central Tokyo.",
        image: {
